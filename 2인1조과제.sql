...
insert into u_info values('aaa111',1122, '홍길동','서울시 마포구', '010-2323-1212','F');
insert into u_info values('bbb222',2233, '김길동','서울시 서초구', '010-3434-4545','M');
insert into u_info values('ccc333',3344, '한길동','서울시 구로구', '010-5656-6767','M');
insert into u_info values('ddd444',4455, '심길동','서울시 종로구', '010-7878-8989','F');
insert into u_info values('eee555',5566, '고길동','서울시 은평구', '010-9090-0101','F');
